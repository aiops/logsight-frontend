...
export class IncidentsAnalyticsComponent implements OnInit {
  ...
  constructor(private verificationService: IncidentsService, private route: ActivatedRoute, private apiService: ApiService) {
  }
